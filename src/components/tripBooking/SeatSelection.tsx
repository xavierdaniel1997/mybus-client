...
export default function SeatSelection() {
  ...
  // helper to toggle seat selection - memoized to prevent re-renders
  const handleSeatClick = useCallback((seatId: string, available: boolean) => {
    if (user) {
      if (!available) return;
      toggleSeat(seatId);
    } else {
